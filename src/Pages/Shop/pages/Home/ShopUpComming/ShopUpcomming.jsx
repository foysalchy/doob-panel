...
const ShopUpcoming = () => {
    ...
    console.log(`http://localhost:5001/api/v1/shop/product/${shop_id.shop_id}/upcoming-product`);
    const { data: products = [], refetch, isLoading } = useQuery({
        queryKey: ["upcoming"],
        queryFn: async () => {
            const res = await fetch(`http://localhost:5001/api/v1/shop/product/${shop_id.shop_id}/upcoming-product`);
