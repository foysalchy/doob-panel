...
const ProfileUpdate = () => {
  const { shopUser, shopId, setToken, setShopUser } =
      ...
      <form onSubmit={submit}>
        <div className="grid md:grid-cols-3 gap-7">
          ...
          <div>
            ...
            {!editProfile ? (
              <div>
                {shopUser ? shopUser.phoneNumber : "Input Your Phone Number"}
              </div>
            ) : (
              <div>
                <input
          ...
          {!editProfile && (
            <div className="flex gap-4 mt-8">
              <button
                ...
                className="bg-blue-500 md:text-md text-[13px] md:w-auto w-full text-white px-4 py-2 rounded"
              >
                Edit Profile
              </button>
              <button
                onClick={() => setOpen(true)}
                className="bg-gray-500 md:text-md text-[13px] md:w-auto w-full text-white px-4 py-2 rounded"
              >
