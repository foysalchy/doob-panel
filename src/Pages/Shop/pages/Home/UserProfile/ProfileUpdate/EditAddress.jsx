...
const EditAddress = ({ data, refetch, setEditAddress, setNewAddress }) => {
    ...
    const submitData = (e) => {
        ...
        console.log(data == true ? "http://localhost:5000/api/v1/shop/upload-Address" : `http://localhost:5000/api/v1/shop/upload-Address?addressId=${data._id}`);
        const url = data == true ? "http://localhost:5000/api/v1/shop/upload-Address" : `http://localhost:5000/api/v1/shop/upload-Address?addressId=${data._id}`
