                    ...
                    <div className={`fixed z-50 top-0 left-0 flex h-full min-h-screen w-full items-center justify-center bg-black bg-opacity-30 shadow-2xl px-4 py-5 ${setOpen ? "block" : "hidden"}`}>
                        <div className="w-full max-w-[800px] h-[90%] rounded-[20px] bg-white pb-10 px-8 text-center md:px-[30px] overflow-scroll">
                            <div className='flex justify-between z-50 pt-4 items-start w-full sticky top-0 bg-white border-b'>
                                ...
                                <div onClick={() => setOpen(!open)} className='cursor-pointer bg-gray-500 rounded-full px-2.5 mb-2 p-1 text-2xl hover:text-red-500'>
                            ...
                            <form onSubmit={submitData} className='text-start'>
                                <div className="mt-4">
                                    ...
                                    <input type="text" defaultValue={shopUser?.name} id="fullName" name="fullName" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block py-2 px-3 w-full shadow-sm sm:text-sm border-gray-300 rounded-md border" />

                                    <label htmlFor="mobileNumber" className="mt-4 text-sm font-medium text-gray-700">Mobile Number</label>
                                    <input defaultValue={shopUser?.phoneNumber} type="text"
                                    ...
                                    <input placeholder="House no. / building / street / area" type="text" id="address" name="address" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block py-2 px-3 w-full shadow-sm sm:text-sm border-gray-300 rounded-md border" />

                                    <label htmlFor="landmark" className="mt-4 text-sm font-medium text-gray-700">Landmark (Optional)</label>
                                    <input type="text" id="landmark" name="landmark" placeholder="E.g. beside train station" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block py-2 px-3 w-full shadow-sm sm:text-sm border-gray-300 rounded-md border" />
