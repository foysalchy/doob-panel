...
const TimeCountDown = ({ start, end }) => {
      ...
      return (
            <div>
                  {timeCount && (
                        <div className="bar overflow-hidden h-10 flex justify-center items-center">
                              <div
                                    className="flex flex-wrap bar overflow-hidden font-sans"
                                    id="countdown"
                              >
                                    {/* Days */}
                                    <div className="my-1 px-1 w-1/2 bar overflow-hidden md:w-1/4 flex justify-center transform transition duration-500 hover:scale-110">
