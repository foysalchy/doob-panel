        ...
        <div className='bg-gray-200'>
            <div className='py-8 w-full   sm:max-w-xl md:max-w-full lg:max-w-screen-lg md:px-24 lg:px-8 lg:py-10 mx-auto'>
                <div className="mt-5 flex justify-between items-baseline my-10">
                    <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Create your {page.shopName} Account.</h3>
                    <h1>
                        Already member? <Link to={`/shop/${page.shopId}/sign-in`} className="font-medium text-indigo-600 hover:text-indigo-500">Login</Link> here.
                    </h1>
                </div>
                <div className="bg-white p-8  ">
                    ...
                    >
                        <div className='w-[60%]'>
                            ...
                            <div className="flex items-center mt-4 justify-between text-sm">
                                <div className="flex items-center gap-x-3">
                                    By clicking “SIGN UP”, I agree to Daraz's <span className=" text-indigo-600 hover:text-indigo-500">Terms of Use</span> and <span className=" text-indigo-600 hover:text-indigo-500">
                                        Privacy Policy
                                    </span>
                                </div>
                        ...
                        <div className='w-[35%] pt-2 flex flex-col gap-4'>
                            ...
                            {shopCredential?.service?.facebook && <button type='button'
                                onClick={() => Facebook()} className="w-full px-8 text-black font-medium bg-gray-300 hover:bg-gray-400 active:bg-red-600 duration-150 mt-[3px] py-[9px] flex gap-8 items-center">
