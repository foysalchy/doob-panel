...
const SeeShopUpcomingProduct = () => {
      ...
      console.log(filterData, "+++++++++>////", shop_id?.shop_id);
                                                            ...
                                                            filterData?.map((itm) => (
                                                                  <div key={itm?._id}>
                                                                        {isGrid === "list" ? (
                                                                              ...
                                                                              >
                                                                                    <a
                                                                                          className="relative md:mx-3 md:mt-3 flex md:h-40 h-full border bar overflow-hidden rounded-xl"
                                                                                          href="#"
                                                                                    >
                                                                                          <img
                                                                              ...
                                                                              <Link
                                                                                    to={`/shop/${shopId}/product/${itm?._id}`}
                                                                                    className="group grid  mb-3 gap-3 w-full p-3 border rounded-lg"
                                                                              >
                                                                                    <a
                                                                                          className="relative  md:border flex h-60 bar overflow-hidden rounded-xl"
                                                                                          href="#"
                                                                                    >
                                                                                          <img
                                                                                                className="peer absolute top-0 right-0 h-full w-full object-cover"
...
export default SeeShopUpcomingProduct;
