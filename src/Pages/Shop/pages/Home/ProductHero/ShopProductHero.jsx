                ...
                .map((item, index) => (
                  <div key={index} className="  inline-block">
                    ...
                    <div>
                      {
                        <Link
                          to={`/shop/${shopId}/product/catagory/${item?._id}`}
                          onMouseEnter={() => subCategoryHandler(item, index)}
                          className={`flex  items-center  w-full justify-between px-2 py-1 capitalize text-sm font-normal  hover:bg-gray-100   relative  ${
                        ...
                        >
                          ...
                          {allCategory?.subCategorys.filter(
                            (subCategory) =>
                              subCategory.megaCategoryId === item?._id
                          ).length >= 1 && (
                          ...
                          {subCategoryData.map((subCategory, index) => (
                            <div key={index}>
                              {miniCategoryData?.length > 0 ? (
                                <div>
                                  ...
                                  {miniCategoryData.length < 1 ? (
                                    ...
                                    <div className="bg-white    border-gray-400 absolute top-0 h-full right-[-180px] px-2 w-[190px]">
                                      {miniCategoryData.map(
                                        (miniCategory, index) => (
                                          <div key={index}>
                                            {!megaSideCategoryData.length ==
                                            0 ? (
                                              <Link
                                            ...
                                            (extraCategory, index) => (
                                              <div key={index}>
                                                ...
                                                0 ? (
                                                  ...
                                                  <Link
                                                    to={`${extraCategory?._id}/categories/${shopId}/${item?.categoryId}`}
                                                  >
                                ...
                                <Link
                                  to={`${item?._id}/categories/${shopId}/${item?.categoryId}`}
                                >
                                  <div
                                    onMouseMove={() =>
                                      miniCategoryHandler(subCategory, index)
