...
const ConfirmOrder = () => {
      ...
      useEffect(() => {
            ...
            // Calculate subtotal
            const subTotal = order.reduce((acc, itm) => acc + (itm.price * itm.quantity), 0);
                                                            ...
                                                            <tbody className="bg-white">
                                                                  {
                                                                        order?.map(itm => <tr key={itm?._id} className="text-gray-700">
                                                                              <td className="px-2 w-[90px] py-2 border border-gray-800">
                                                                                    <img src={itm?.img} alt="photo" className="w-12 h-12 border object-cover m-auto rounded bg-indigo-400" />
                                                                              </td>
                  ...
                  <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                        ...
                        <div className="hidden grid-cols-3 gap-3">
                              <div className="col-span-2">
                                    <>
                                          <div className="p-6 bar overflow-x-auto px-0">
                                                            ...
                                                            {order?.map(itm => (
                                                                  <tr key={itm?._id}>
                                                                        <td className="p-4 w-[110px] border-b border-blue-gray-50">
                                                                              <img src={itm?.img} alt="" className="w-[100px] h-[80px] rounded border" />
                                                                        </td>
