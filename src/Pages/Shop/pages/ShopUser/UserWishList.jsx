...
const UserWishList = () => {
    ...
    const { data: wishlist = {}, isLoading, refetch } = useQuery({
        queryKey: ["wishlist"],
        queryFn: async () => {
            const res = await fetch(`http://localhost:5000/api/v1/shop/user/wishlist?userId=${shopUser._id}&shopId=${shop_id.shop_id}`);
    ...
    const removeWishlist = (wishListId) => {
        fetch(`http://localhost:5000/api/v1/shop/user/wishlist?wishlistId=${wishListId}`, {
            method: "DELETE",
            headers: {
