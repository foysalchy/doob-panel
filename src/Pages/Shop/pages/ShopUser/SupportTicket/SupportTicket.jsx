      ...
      const { data: supportTickets = [], refetch } = useQuery({
            ...
            queryFn: async () => {
                  const res = await fetch(
                        `https://doob.dev/api/v1/shop/support?shopId=${shop_id.shop_id}&token=${shopUser._id}`
                  );
            ...
            <section className="">
                  <div className="flex md:flex-row flex-col md:justify-between justify-center  md:items-start items-center">
                        <button
                              ...
                              className="inline-block px-6 py-2.5 border rounded-md border-blue-500 text-primary hover:bg-blue-500 hover:text-white font-medium -mx-4 mb-4 md:w-auto w-full"
                        >
                              New Support Ticket
                        </button>
                        <AddNewTicket
                        ...
                        <div className="md:mt-0 mt-3">
                              <div className="flex flex-wrap -mx-4">
                                    <div className="w-full ">
                                          <div className="max-w-full bar overflow-x-auto">
                                                <table className="w-full table-auto">
                                                      <thead className="text-center bg-gray-900">
                                                            <tr>
                                                                  <th className={`${TdStyle.ThStyle} rounded-tl-xl`}>
                                                                        {" "}
                                                                        Id{" "}
                                                                  </th>
                                                                  ...
                                                                  <th className={`${TdStyle.ThStyle} rounded-tr-xl`}>
                                                                        {" "}
                                                                        Action{" "}
                                                                  </th>
                                                            </tr>
                                                            ...
                                                            {viewComment && (
                                                                  <div>
                                                                        <ViewUserSupportTicket
                                                                              ...
                                                                              ticketDetails={filteredData.find(
                                                                                    (ticket) => ticket._id === viewComment
                                                                              )}
                                                                        />
                                                                  </div>
                                                            )}
