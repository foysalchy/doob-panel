...
const Search_Item = () => {
      ...
      const fetchFilteredProducts = async () => {
            ...
            if (params.size > 0) {
                  ...
                  console.log({ shop_id: shop_id.shop_id, search });
                  const response = await fetch(`https://doob.dev/api/v1/shop/search`, {
                        method: "POST",
                        body: JSON.stringify({ shop_id: shop_id.shop_id, term: search }),
                        headers: {
                                                                              ...
                                                                              >
                                                                                    ...
                                                                                    <div className=" ">
                                                                                          <div
                                                                                                ...
                                                                                                dangerouslySetInnerHTML={{ __html: product?.shortDescription?.slice(0, 150) }}
                                                                                          />
                                                                                    ...
                                                                                    <div className="flex items-center gap-4">
                                                                                          <div className="flex items-center gap-1 text-orange-500">
                                                                                                {myRating(product.rating_count).map((product) => (
                                                                                                      <FaStar className="text-orange-500" />
                                                                                                ))}{" "}
