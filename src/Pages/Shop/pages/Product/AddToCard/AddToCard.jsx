...
const ProductListCartSm = ({
    ...
    const addToFavorite = (favorite) => {
        ...
        fetch("http://localhost:5001/api/v1/shop/user/wishlist", {
            method: 'POST',
...
const AddToCard = () => {
    ...
    const handleRemove = (productId) => {
        ...
        fetch(`http://localhost:5001/api/v1/shop/user/add-to-cart?productId=${productId}&token=${shopUser._id}`, {
            method: "DELETE",
    ...
    //     console.log(price);
    //     fetch(`http://localhost:5001/api/v1/shop/user/promocode?shopId=${shopId}&code=${code}&token=${shopUser._id}&price=${price}`, {
    //         headers: {
