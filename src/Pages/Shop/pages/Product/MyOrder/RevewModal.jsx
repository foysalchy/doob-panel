        ...
        for (let i = 0; i < 5; i++) {
            ...
            stars.push(
                <button type='button' key={i} onClick={() => handleStarClick(i)}>
                    <svg
                        className={`h-6 w-6 ${isGold ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-600'}`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
    ...
    return (
        <div>
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                <form onSubmit={upload_my_review} className="mx-4 w-full  lg:max-w-md rounded-lg bg-white p-6 shadow-lg ">
                    <div className="space-y-4">
                        ...
                        <div className="flex justify-end  space-x-2">
                            <button disabled={loader} onClick={() => setOrder_review(false)}
                            ...
                            <button
                                ...
                                className={`rounded-md bg-primary px-4 py-2 text-sm font-medium text-white ${loader ? 'opacity-50 cursor-not-allowed' : 'hover:bg-primary-600'
