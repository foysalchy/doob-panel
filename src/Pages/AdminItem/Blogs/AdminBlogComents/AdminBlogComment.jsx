                    ...
                    {adminBlogsComments.map((blog) => (
                        <tr>
                            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div className="inline-flex items-center gap-x-3">
                                    ...
                                    <div className="flex items-center gap-x-2">
                                        <div className='text-xl p-2 px-4 bg-gray-300 rounded-full'>{blog?.user?.name?.slice(0, 1)}</div>
                                        <div>
                            ...
                            <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                {blog.status ? <button onClick={() => publishBlogComment(blog.blogId, blog.timeStamp, false)} className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 bg-gray-800">
                                    <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
                                    <h2 className="text-sm font-normal text-emerald-500">
                                        Active
                                    </h2>
                                </button> :
                                    <button onClick={() => publishBlogComment(blog.blogId, blog.timeStamp, true)} className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 bg-gray-800">
