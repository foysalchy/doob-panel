...
const AddMegaCategory = () => {
    ...
    const postCategory = (categoryData, form) => {
        fetch("http://localhost:5001/api/v1/admin/category/megacategory", {
            method: 'post',
            headers: {
        ...
        <div>
            <form onSubmit={handleSubmit} className="lg:max-w-3xl ring-1 ring-gray-200 rounded-xl m-auto w-full md:p-4 p-2">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input required type="text" name="name" id="name" className="w-full border-2 border-gray-300 p-2 rounded-lg mb-2" />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="slag">
                        Slag
                    </label>
                    <input required type="text" name="slag" id="slag" className="w-full border-2 border-gray-300 p-2 rounded-lg mb-2" />
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="upload">
                        Upload Image
                    </label>
                    <input required type="file" name="img" id="upload" className="w-full border-2 border-gray-300 p-2 rounded-lg mb-2" />
                </div>
                <div className="flex flex-col gap-2">
