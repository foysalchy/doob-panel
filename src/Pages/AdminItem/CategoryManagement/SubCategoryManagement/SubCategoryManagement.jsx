...
const SubCategoryManagement = () => {
    ...
    const { data: subCategory = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch("http://localhost:5000/api/v1/admin/category/subcategories");
    ...
    const statusUpdate = (id, status) => {
        fetch(`http://localhost:5000/api/v1/admin/category/subcategory?id=${id}&status=${status}`, {
            method: "PUT",
            headers: {
