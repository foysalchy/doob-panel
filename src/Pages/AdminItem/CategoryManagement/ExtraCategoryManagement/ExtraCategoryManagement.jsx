...
const ExtraCategoryManagement = () => {
    ...
    const { data: extraCategory = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch("http://localhost:5000/api/v1/admin/category/extraCategories");
    ...
    const statusUpdate = (id, status) => {
        fetch(`http://localhost:5000/api/v1/admin/category/extraCategory?id=${id}&status=${status}`, {
            method: "PUT",
            headers: {
    ...
    // status update
    const onDelete = (id) => {
        fetch(`http://localhost:5000/api/v1/admin/category/extraCategory?id=${id}`, {
            method: "DELETE",
            headers: {
                "content-type": "application/json",
            },
