...
const Daraz_ship = ({
      ...
      const orderSubmit = async (event) => {
            ...
            if (selectedDelivery === "Other" || selectedDelivery === undefined) {
                  ...
                  try {
                        local_status_updated(orderInfo);
                        setLoading(false);
                  } catch (error) {
                                                            ...
                                                            <>
                                                                  <div className="mt-2">
                                                                        ...
                                                                        <input
                                                                              ...
                                                                              readOnly
                                                                              className="flex-grow w-full re h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-400 focus:outline-none focus:shadow-outline"
                                                                              defaultValue={orderInfo.order_number}
                                                                              type="text"
                                                                              id="title"
                                                                              name="invoice"
                                                                        />
                                                                  ...
                                                                  <div className="mt-2">
                                                                        ...
                                                                        <input
                                                                              required
                                                                              className="flex-grow w-full re h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-400 focus:outline-none focus:shadow-outline"
                                                                              defaultValue={orderInfo?.address_shipping && `${orderInfo?.address_shipping?.first_name} ${orderInfo?.address_shipping?.last_name}`}
                                                                              type="text"
                                                                              id="title"
                                                                              name="recipient_name"
                                                                        />
                                                                  ...
                                                                  <div className="mt-2">
                                                                        ...
                                                                        <input
                                                                              required
                                                                              className="flex-grow w-full re h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-400 focus:outline-none focus:shadow-outline"
                                                                              defaultValue={orderInfo?.address_shipping?.phone}
                                                                              type="text"
                                                                              id="title"
                                                                  ...
                                                                  <div className="mt-2">
                                                                        ...
                                                                        <textarea
                                                                              ...
                                                                              defaultValue={orderInfo?.address_shipping && `${orderInfo?.address_shipping?.address1 ?? ""},\n${orderInfo?.address_shipping?.address2 ?? ""},\n${orderInfo?.address_shipping?.address3 ?? ""},\n${orderInfo?.address_shipping?.address4 ?? ""}\n${orderInfo?.address_shipping?.address5 ?? ""}`}
                                                                              type="text"
                                                                              id="title"
                                                                  ...
                                                                  <>
                                                                        <div className="mt-2">
                                                                              ...
                                                                              <input
                                                                                    ...
                                                                                    readOnly
                                                                                    className="flex-grow w-full re h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-400 focus:outline-none focus:shadow-outline"
                                                                                    defaultValue={orderInfo.invoice_number}
                                                                                    type="text"
                                                                                    id="title"
                                                                                    name="invoice"
                                                                              />
