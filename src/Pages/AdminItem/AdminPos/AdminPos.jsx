...
import PosSidebar from "./AdminPosSidebar";
import clickAudio from "../../../../src/assets/sound_beep-29.mp3";
import AdminPosSidebar from "./AdminPosSidebar";
const AdminPos = () => {
      ...
      //     queryKey: ["products"],
      //     queryFn: async () => {
      //         const res = await fetch(`https://doob.dev/api/v1/seller/all-products/${shopInfo._id}`);
      ...
      return (
            <div>
                  <main className=" md:p-4 mt-3 rounded-md h-[82vh] bar overflow-y-auto">
                        <div className="grid md:grid-cols-3 gap-2 ">
                              <div className="md:col-span-2">
                                    ...
                                    <div className="bg-gray-100 p-4 rounded-lg mt-3  bar overflow-y-auto grid md:grid-cols-3 grid-cols-2 gap-3 h-[90vh]">
                                          {filteredData.length
