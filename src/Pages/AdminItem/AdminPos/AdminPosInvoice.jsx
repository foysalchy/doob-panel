...
const AdminPosInvoice = ({ invoiceData, setInvoiceOpen, invoiceOpen }) => {
      ...
      return (
            <>
                  {
                        invoiceOpen && <div className="bg-gray-100 p-12  w-screen h-screen bar overflow-x-hidden bar overflow-h-auto fixed top-0 left-0 bottom-0 right-0">
...
export default AdminPosInvoice;
