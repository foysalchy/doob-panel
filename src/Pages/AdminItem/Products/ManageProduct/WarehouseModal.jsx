...
const WarehouseModal = ({ modalOpen, setModalOpen, product, doobProduct }) => {
    ...
    const { data: warehouses = [], refetch, isRefetching } = useQuery({
        queryKey: ["warehouses"],
        queryFn: async () => {
            const getWarehouseApiUrl = "http://localhost:5000/api/v1/admin/warehouse";
    ...
    const handleWarehouseChange = async (selectedOption) => {
        ...
        const getAreaApiUrl = `http://localhost:5000/api/v1/admin/warehouse/area/${selectedWarehouse}`;
    ...
    const handleAreaChange = async (selectedOption) => {
        ...
        const getRackApiUrl = `http://localhost:5000/api/v1/admin/warehouse/rack/${selectedWarehouse}/${selectedArea}`;
    ...
    const handleReckChange = async (selectedOption) => {
        ...
        const getSelfApiUrl = `http://localhost:5000/api/v1/admin/warehouse/self/${selectedWarehouse}/${selectedArea}/${selectedRack}`;
    ...
    const handleSelfChange = async (selectedOption) => {
        ...
        const getCellApiUrl = `http://localhost:5000/api/v1/admin/warehouse/cell/${selectedWarehouse}/${selectedArea}/${selectedRack}/${selectedSelf}`;
