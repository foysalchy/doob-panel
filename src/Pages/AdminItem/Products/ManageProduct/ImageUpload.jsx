...
const ImageUpload = ({ coverPhoto, setCoverPhoto, youtube, setYoutube }) => {
                        ...
                        <div className="grid md:grid-cols-8 gap-2 grid-cols-2 mt-4">
                              ...
                              <div
                                    ...
                                    <input
                                          ...
                                          className='w-[20px] absolute top-0 left-0 bottom-0 right-0 m-auto bar overflow-hidden opacity-0 cursor-pointer'
                                          name="coverPhoto"
                                          accept="image/*"
                                          style={{ display: "block" }}
                              ...
                              >
                                    ...
                                    <input
                                          ...
                                          name="photo1"
                                          className='absolute top-0 left-0 bottom-0 right-0 m-auto bar overflow-hidden w-[20px] opacity-0 cursor-pointer'
                                          accept="image/*"
                                          style={{ display: "block" }}
