            ...
            <div className="bg-gray-200 w-full h-full p-10">
                  ...
                  <div className="flex gap-10 pl-1">
                        <div>
                              <button
                                    ...
                                    className="group relative inline-flex mb-10 items-center bar overflow-hidden rounded bg-gray-900 px-8 py-3 text-white focus:outline-none focus:ring active:bg-gray-500"
                  ...
                  <>
                        <div className=" py-2 bar overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
                              <div className="align-middle rounded-tl-lg rounded-tr-lg inline-block w-full py-4 bar overflow-hidden bg-white shadow-lg px-12">
                              ...
                              {
                                    <div className="align-middle inline-block min-w-full shadow bar overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
