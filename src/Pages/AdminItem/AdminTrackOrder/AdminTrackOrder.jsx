            ...
            <main className="main">
              <div id="details" className="clearfix">
                <div id="client">
                  ...
                  <div className="address">
                    {order?.addresses?.address} {order?.addresses?.area}{" "}
                    {order?.addresses?.city} {order?.addresses?.province}
                  </div>
                  <div className="email">
                    <a href="mailto:john@example.com">
                      {order?.addresses?.mobileNumber}
                    </a>
                  </div>
                </div>
                <div id="invoice">
                  <h1>INVOICE</h1>
                  <div className="date">
                    Date of Invoice: {formatTimestamp(order?.timestamp)}
                  </div>
                </div>
              </div>
              <table
              ...
              >
                ...
                <tbody className="tbody">
                  {order?.productList?.map((list, index) => (
