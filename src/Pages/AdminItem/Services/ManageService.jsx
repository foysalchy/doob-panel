...
const ManageService = () => {
    ...
    const { data: services = [], refetch, isLoading } = useQuery({
        queryKey: ["services"],
        queryFn: async () => {
            const res = await fetch("http://localhost:5001/api/v1/admin/services");
    ...
    const ActiveHandle = (id) => {
        ...
        fetch(`http://localhost:5001/api/v1/admin/service/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DeactiveHandle = (id) => {
        ...
        fetch(`http://localhost:5001/api/v1/admin/service/unstatus/${id}`, {
            method: "PUT",
            headers: {
                "content-type": "application/json",
            },
    ...
    const DeleteHandle = (id) => {
        ...
        fetch(`http://localhost:5001/api/v1/admin/service/delete/${id}`, {
            method: "Delete",
            headers: {
                "content-type": "application/json",
            },
