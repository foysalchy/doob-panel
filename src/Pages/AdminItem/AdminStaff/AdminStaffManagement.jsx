...
const AdminStaffManagement = () => {
  ...
  const { data: staffInfo = [], refetch, isLoading } = useQuery({
    queryKey: ["staffInfo"],
    queryFn: async () => {
  ...
  if (isDelete) {
    fetch(`https://doob.dev/api/v1/admin/staff-delete?email=${deleteId}`, {
      method: "PUT",
      headers: {
