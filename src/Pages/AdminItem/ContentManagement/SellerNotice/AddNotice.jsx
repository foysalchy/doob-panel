...
const AddNotice = () => {
    ...
    const postSlider = (Slider) => {
        ...
        fetch(`https://salenow-v2-backend.vercel.app/api/v1/admin/seller-notice`, {
            method: "POST",
            headers: {
            ...
            <div>
                <div className=' border-black p-10 rounded border-dashed border-2  my-4'>
                    <form onSubmit={UploadSlider} action="">
                        ...
                        <div className="mt-4">
                            <label className="block text-sm font-medium text-gray-700">Provide Notice Title</label>
                            <input
                                required
                                name='title'
                        ...
                        <div className="mt-4">
                            <label className="block text-sm font-medium text-gray-700">Provide Notice Url</label>
                            <input
                                required
                                name='url'
