...
const AdminFeatureImageAdd = () => {
    ...
    const postSlider = (Slider) => {
        ...
        fetch(`https://backend.doob.com.bd/api/v1/admin/feature-image`, {
            method: "POST",
            headers: {
            ...
            <div>
                <div className=' border-black p-10 rounded border-dashed border-2  my-4'>
                    <form onSubmit={UploadSlider} action="">
                        ...
                        <div className="mt-4">
                            <label className="block text-sm font-medium text-gray-700">Provide Feature Image where it redirect Url</label>
                            <input
                                required
                                name='url'
...
export default AdminFeatureImageAdd;