...
const AdminFeatureImage = () => {
    ...
    const EditStatus = (id, status) => {
        ...
        setLoading(true)
        fetch(`http://localhost:5000/api/v1/admin/feature-image?id=${id}&status=${status}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const onDelete = (id) => {
        setLoading(true)
        fetch(`http://localhost:5000/api/v1/admin/feature-image?id=${id}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
            },
            ...
            <section className=" mt-4 mx-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                        {featureImage.map(itm => <tr key={itm?._id}>
