...
const AdminSliderAdd = () => {
    ...
    const postSlider = (Slider) => {
        ...
        fetch(`https://backend.doob.com.bd/api/v1/admin/slider`, {
            method: "POST",
            headers: {
            ...
            <div>
                <div className=' border-black p-10 rounded border-dashed border-2  my-4'>
                    <form onSubmit={UploadSlider} action="">
                        ...
                        <div className="mt-4">
                            <label className="block text-sm font-medium text-gray-700">Provide Slider Image where it redirect Url</label>
                            <input
                                required
                                name='url'
                                placeholder="www.doob.com.bd/"
                        ...
                        <button type='submit' className="group mt-4 relative inline-flex items-center overflow-hidden rounded bg-gray-900 px-8 py-3 text-white focus:outline-none focus:ring active:bg-gray-500">
                            ...
                            <span className="text-sm font-medium transition-all group-hover:ms-4">{loading ? 'Uploading ...' : 'Add Upload'}</span>
                        </button>
                    </form>
                </div>
            </div>
