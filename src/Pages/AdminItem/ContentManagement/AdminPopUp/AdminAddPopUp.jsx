...
const AdminAddPopUp = () => {
    ...
    const postSlider = (Slider) => {
        ...
        fetch(`https://backend.doob.com.bd/api/v1/admin/pop-up`, {
            method: "POST",
            headers: {
            ...
            <div>
                <div className=' border-black p-10 rounded border-dashed border-2  my-4'>
                    <form onSubmit={UploadSlider} action="">
                        ...
                        <div className="mt-4">
                            <label className="block text-sm font-medium text-gray-700">Provide Pop Title</label>
                            <input
                                required
                                name='title'
                        ...
                        <div className="mt-4">
                            <label className="block text-sm font-medium text-gray-700">Provide Pop Url</label>
                            <input
                                required
                                name='url'
