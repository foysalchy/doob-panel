...
const AddAnouncement = () => {
    ...
    const postSlider = (Slider) => {
        ...
        fetch(`http://localhost:5001/api/v1/admin/announcement`, {
            method: "POST",
            headers: {
            ...
            <div>
                <div className=' border-black p-10 rounded border-dashed border-2  my-4'>
                    <form onSubmit={UploadSlider} action="">
                        ...
                        <div className="mt-4">
                            <label className="block text-sm font-medium text-gray-700">Provide Announcement Title</label>
                            <input
                                required
                                name='title'
                        ...
                        <div className="mt-4">
                            <label className="block text-sm font-medium text-gray-700">Provide Announcement Url</label>
                            <input
                                required
                                name='url'
