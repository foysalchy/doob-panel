  ...
  return (
    <div>
      ...
      <form onSubmit={buyingDomain} className="">
        <div>
          <label for="domain name" class="block text-sm text-gray-900">
            Domain Name :{" "}
            <span className="text-green-500">{buyDomain?.url}</span>
          </label>

          <div class="flex items-center mt-2">
            <p class="py-2.5 px-3 text-gray-500 bg-gray-100 dark:bg-gray-800 dark:border-gray-700 border border-r-0 rtl:rounded-r-lg rtl:rounded-l-none rtl:border-l-0 rtl:border-r rounded-l-lg w-[150px]">
              Buying Url
            </p>
            <input
              name="url"
