      ...
      const dataSubmit = (event) => {
            ...
            const formData = {
                  ...
                  ...(selectedMedia === "Bank" && {
                        ...
                        brach_name: event.target.brach_name.value,
                  }),
            };
                              ...
                              <div className="flex items-center justify-center gap-4 my-4 ">
                                    {Array.isArray(getaway) && getaway.map((get) => (
                                          <div key={get._id}>
                                                ...
                                                {get.Getaway === "Bank" && (
                                                      <div className="group relative block border  bg-white">
                                                            <div className="absolute inset-0 p-4 w-full  opacity-75 transition-opacity group-hover:opacity-20 flex justify-center items-center">
                                                                  {get?.bank_name}
                                                            </div>
