...
const PageManagement = () => {
  ...
  const ActiveHandle = (id) => {
    ...
    fetch(`http://localhost:5001/api/v1/admin/page/status/${id}`, {
      method: "PUT",
      headers: {
  ...
  const DeactiveHandle = (id) => {
    ...
    fetch(`http://localhost:5001/api/v1/admin/page/unstatus/${id}`, {
      method: "PUT",
      headers: {
        "content-type": "application/json",
      },
  ...
  const DeleteHandle = (id) => {
    ...
    fetch(`http://localhost:5001/api/v1/admin/page/delete?id=${id}`, {
      method: "Delete",
      headers: {
        "content-type": "application/json",
      },
