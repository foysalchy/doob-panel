...
const AddPage = () => {
    ...
    const dataSubmit = (event) => {
        ...
        fetch(`https://salenow-kmg7yawl2-salenow-backend.vercel.app/admin/addpage`, {
            method: "POST",
            headers: {
            ...
            <nav aria-label="breadcrumb" className="w-full my-20 p-4 mb-4 rounded dark:bg-gray-800 dark:text-gray-100">
                <ol className="flex h-8 space-x-2">
                    ...
                    <li className="flex items-center space-x-2">
                        ...
                        <Link rel="noopener noreferrer" to={'/admin/pagemanagement/addpage'} className="flex items-center px-1 capitalize hover:underline">Add Page</Link>
                    </li>
