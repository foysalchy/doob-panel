...
const AddCellModal = ({ recall, setOpenModal }) => {
    ...
    const handleWarehouseChange = async (selectedOption) => {
        ...
        const areaRes = await fetch(`http://localhost:5001/api/v1/admin/warehouse/area/${selectedWarehouse}`);
    ...
    const handleAreaChange = async (selectedOption) => {
        ...
        const rackRes = await fetch(`http://localhost:5001/api/v1/admin/warehouse/rack/${selectedWarehouse}/${selectedArea}`);
    ...
    const handleReckChange = async (selectedOption) => {
        ...
        const selfRes = await fetch(`http://localhost:5001/api/v1/admin/warehouse/self/${selectedWarehouse}/${selectedArea}/${selectedRack}`);
        console.log(selfRes);
    ...
    const UploadArea = (e) => {
        ...
        fetch('http://localhost:5001/api/v1/admin/warehouse/cell', {
            method: 'post',
            headers: {
