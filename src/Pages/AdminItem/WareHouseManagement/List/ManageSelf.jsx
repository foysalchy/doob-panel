...
const ManageSelf = () => {
    ...
    const { data: selfs = [], refetch } = useQuery({
        queryKey: ["selfs"],
        queryFn: async () => {
            const res = await fetch("http://localhost:5000/api/v1/admin/warehouse/self");
    ...
    const updateStatus = (id, status) => {
        fetch(`http://localhost:5000/api/v1/admin/warehouse/self/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DeleteWarehouse = (id) => {
        ...
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                ...
                fetch(`http://localhost:5000/api/v1/admin/warehouse/self/delete/${id}`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    },
