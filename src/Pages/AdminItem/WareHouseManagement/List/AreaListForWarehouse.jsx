...
const AreaListForWarehouse = () => {
    ...
    const { data: areas = [], refetch } = useQuery({
        queryKey: ["areas"],
        queryFn: async () => {
            const res = await fetch("https://backend.doob.com.bd/api/v1/admin/warehouse/area");
    ...
    const updateStatus = (id, status) => {
        fetch(`https://backend.doob.com.bd/api/v1/admin/warehouse/area/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DeleteWarehouse = (id) => {
        ...
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                ...
                fetch(`https://backend.doob.com.bd/api/v1/admin/warehouse/area/delete/${id}`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    },
    ...
    return (
        <div>
            <div className="mt-4 lg:pr-10 w-full mx-auto overflow-auto">
                ...
                {OpenModal === 'Add Area' && <ModalForWarehouse OpenModal={OpenModal} setOpenModal={setOpenModal} data={'Add Area'} refetch={refetch} />}
