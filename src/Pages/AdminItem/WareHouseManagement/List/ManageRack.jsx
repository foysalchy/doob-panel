...
const ManageRack = () => {
    ...
    const { data: racks = [], refetch } = useQuery({
        queryKey: ["racks"],
        queryFn: async () => {
            const res = await fetch("https://salenow-v2-backend.vercel.app/api/v1/admin/warehouse/rack");
    ...
    const updateStatus = (id, status) => {
        fetch(`https://salenow-v2-backend.vercel.app/api/v1/admin/warehouse/rack/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DeleteWarehouse = (id) => {
        ...
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                ...
                fetch(`https://salenow-v2-backend.vercel.app/api/v1/admin/warehouse/rack/delete/${id}`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    },
    ...
    return (
        <div>
            <div className="mt-4 lg:pr-10 w-full mx-auto overflow-auto">
                ...
                {OpenModal === 'Add Rack' && <ModalForWarehouse OpenModal={OpenModal} setOpenModal={setOpenModal} data={'Add Rack'} refetch={refetch} />}
