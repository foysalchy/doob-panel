...
const ManageCell = () => {
    ...
    const { data: cells = [], refetch } = useQuery({
        queryKey: ["cells"],
        queryFn: async () => {
            const res = await fetch("http://localhost:5001/api/v1/admin/warehouse/cell");
    ...
    const updateStatus = (id, status) => {
        fetch(`http://localhost:5001/api/v1/admin/warehouse/cell/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DeleteWarehouse = (id) => {
        ...
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                ...
                fetch(`http://localhost:5001/api/v1/admin/warehouse/cell/delete/${id}`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    },
