...
const SellerPageManagement = () => {
    ...
    const { data: faqs = [], refetch } = useQuery({
        queryKey: ["faqs"],
        queryFn: async () => {
            const res = await fetch(`https://salenow-v2-backend.vercel.app/seller/pages/${shopInfo.shopId}`);
    ...
    const ActiveHandle = (id) => {
        ...
        fetch(`https://salenow-v2-backend.vercel.app/seller/page/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DativeHandle = (id) => {
        ...
        fetch(`https://salenow-v2-backend.vercel.app/seller/page/falseStatus/${id}`, {
            method: "PUT",
            headers: {
                "content-type": "application/json",
            },
    ...
    const DeleteHandle = (id) => {
        ...
        fetch(`https://salenow-v2-backend.vercel.app/seller/page/delete/${id}`, {
            method: "Delete",
            headers: {
                "content-type": "application/json",
            },
