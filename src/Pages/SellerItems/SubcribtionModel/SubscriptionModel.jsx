...
const SubscriptionModel = () => {
    ...
    const { data: pricesData = [], refetch } = useQuery({
        queryKey: ["pricesData"],
        queryFn: async () => {
            const res = await fetch("http://localhost:5001/api/v1/admin/pricing");
            const data = await res.json();
            return data;
        },
    });
    ...
    console.log(`http://localhost:5001/api/v1/seller/check-free-trail?shopId=${shopInfo._id}`, 'posible');
