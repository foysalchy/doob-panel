...
//   if (check_expired() && !prices?.orderInfo) {
//     return (
//       <div className="bg-orange-100 px-2 py-3 rounded flex justify-between items-center">
//         <div className="text-sm text-orange-800 capitalize flex items-center gap-2">
//           Hi dear, You are using a free trial. Please update your package
//           <Link to={`/price`}>
//             <div className="flex items-center mt-auto text-white bg-orange-500 border-0 py-1 px-4 focus:outline-none hover:bg-orange-600 rounded">
//               Update
//             </div>
//           </Link>
//         </div>
...
//     return (
//       <div className="bg-orange-100 px-2 py-3 rounded flex justify-between items-center">
//         <p className="text-sm text-orange-800 capitalize">Expired</p>
//         <div className="h-0 w-0">
//           {invoice && (
//             <SubscriptionInvoice
//               pricesData={pricesData}
...
//                   <span className="text-black">Amount :</span> {amount ? amount : 0} ৳
//                 </li>
//                 <li className="text-sm text-gray-500">
//                   <span className="text-black">Buying Price :</span> {prices?.orderInfo?.buyingPrice ? prices?.orderInfo?.buyingPrice : 0} ৳
//                 </li>
//                 <li className="text-sm text-gray-500">
