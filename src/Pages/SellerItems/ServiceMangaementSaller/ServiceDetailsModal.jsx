...
export default function ServiceDetailsModal({
      ...
      return (
            ...
            >
                  <div className="w-full    max-w-[90%] mx-auto overflow-hidden  rounded-[20px] bg-white pb-10 px-4 text-center md:px-[20px]">
                        ...
                        <table className="divide-y">
                              <thead className="bg-gray-50  w-[95%] overflow-scroll">
                                    <tr>
                                          <th
                                                scope="col"
