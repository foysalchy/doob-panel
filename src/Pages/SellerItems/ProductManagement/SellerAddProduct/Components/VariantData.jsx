...
// const VariantData = ({ inputFields, variantInput, setVariantInput }) => {
...
//     console.log(inputFields[0], 'variant');

//     const handleInputChange = (index, field, value, discount) => {
//         const newInputFields = [...variantInput];
//         const priceField = `${field}Price`;
//         const discountedPrice = value - (value * discount / 100);

//         newInputFields[0][field].quantity = value;
//         newInputFields[0][field][priceField] = discountedPrice;
                ...
                <div className={`border p-2 border-gray-300 bg-orange-100`}>
                    ...
                    <div className={`flex gap-3 `}>
                        <div>
                            <label className={style.label} htmlFor="">Quantity</label>
                            <input
                                onChange={(e) => handleInputChange(0, 'product1', e.target.value, 5)}
                                type="text"
                                defaultValue={1}
                ...
                <div className={`border p-2 border-gray-300 bg-orange-100`}>
                    ...
                    <div className="flex gap-3">
                        <div>
                            <label className={style.label} htmlFor="">Quantity</label>
                            <input
                                onChange={(e) => handleInputChange(0, 'product2', e.target.value, 10)}
                                type="text"
                                defaultValue={10}
                                className={style.input}
                            />
                ...
                <div className={`border p-2 border-gray-300 bg-orange-100`}>
                    ...
                    <div className="flex gap-3">
                        <div>
                            <label className={style.label} htmlFor="">Quantity</label>
                            <input
                                onChange={(e) => handleInputChange(0, 'product3', e.target.value, 15)}
                                type="text"
                                defaultValue={50}
                                className={style.input}
                            />
