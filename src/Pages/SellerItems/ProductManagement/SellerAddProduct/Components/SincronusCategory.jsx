                    ...
                    {(shopInfo.darazLogin) &&
                        <div className='flex flex-col '>
                            ...
                            <button type='button' className='flex justify-start mt-2' >
                                <span onClick={() => {
                                    setDaraz(false);
                                    setInputFields([{ name: null, image: null, quantity: "", SKU: "", price: null, offerPrice: null, ability: false, vendor: false }]);
                                }} className={daraz ? "px-4 py-2 bg-gray-600 text-white " : "px-4 py-2 bg-violet-400"}>NO</span>
                                <span onClick={() => {
                                    setDaraz(true);
                                    setInputFields([{ name: null, image: null, quantity: "", SKU: "", price: null, offerPrice: null, ability: false, vendor: false }]);
                ...
                <div className='flex flex-col mt-3'>
                    ...
                    <div className='grid md:grid-cols-4 mt-3 items-center gap-4'>
                        <Select
                            ...
                            onChange={(e) => handleCategoryChange(e.label)}
                            placeholder='Select Category'
                            options={megaCategories.map(megaCategory => ({ value: megaCategory.name, label: megaCategory.name }))}
                            className=''
                        />
                        {selectedCategory &&
                            <Select
                                ...
                                onChange={(e) => handleSubcategoryChange(e.value)}
                                placeholder='Select SubCategory'
                                options={subCategories.map(subCategory => ({ value: subCategory.subCategoryName, label: subCategory.subCategoryName }))}
                            />
                        }
                        {selectedSubcategory && <Select
                            name='miniCategory'
                            placeholder='Select MiniCategory'
                            onChange={(e) => handleMinicategoryChange(e.value)}
                            options={miniCategories.map(miniCategory => ({ value: miniCategory.miniCategoryName, label: miniCategory.miniCategoryName }))}
                        />
                        }
                        {selectedMinicategory &&
                            <Select
                                ...
                                placeholder='Select ExtraCategory'
                                onChange={(e) => handleExtracategoryChange(e.value)}
                                options={extraCategories.map(extraCategory => ({ value: extraCategory.extraCategoryName, label: extraCategory.extraCategoryName }))}
                            />
                        }
                    </div>
