...
//         queryFn: async () => {
//             const res = await fetch(`https://doob.dev/api/v1/category/seller/mega-category/get/${shopInfo._id}`);
...
//         queryFn: async () => {
//             if (selectedCategory) {
//                 const res = await fetch(`https://doob.dev/api/v1/category/seller/sub-category/get/${shopInfo._id}/${selectedCategory}`);
//                 const data = await res.json();
//                 if (data) {
//                     if (data?.daraz) {
...
//                 const res = await fetch(`https://doob.dev/api/v1/category/seller/mini-category/get/${shopInfo._id}/${selectedSubcategory}`);
//                 const data = await res.json();
//                 if (data) {
//                     if (data?.daraz) {
//                         setDarazOption(data?.daraz);
...
//                 const res = await fetch(`https://doob.dev/api/v1/category/seller/extra-category/get/${shopInfo._id}/${selectedMinicategory}`);
//                 const data = await res.json();
//                 if (data) {
//                     if (data?.daraz) {
//                         setDarazOption(data?.daraz);
