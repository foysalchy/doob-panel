...
const WareHouse = ({ adminWare, setAdminWare, shopInfo }) => {
    ...
    const { data: warehouses = [], refetch, isRefetching } = useQuery({
        queryKey: ["warehouses"],
        queryFn: async () => {
            const getWarehouseApiUrl = adminWare ? "http://localhost:5001/api/v1/admin/warehouse" : `http://localhost:5001/api/v1/seller/warehouse/get/${shopInfo._id}`;
    ...
    const handleWarehouseChange = async (selectedOption) => {
        ...
        const getAreaApiUrl = `http://localhost:5001/api/v1/seller/warehouse/area/${selectedWarehouse}/${shopInfo._id}`;
    ...
    const handleAreaChange = async (selectedOption) => {
        ...
        const getRackApiUrl = `http://localhost:5001/api/v1/seller/warehouse/rack/${selectedWarehouse}/${selectedArea}/${shopInfo._id}`;
    ...
    const handleReckChange = async (selectedOption) => {
        ...
        const getSelfApiUrl = `http://localhost:5001/api/v1/seller/warehouse/self/${selectedWarehouse}/${selectedArea}/${selectedRack}/${shopInfo._id}`;
    ...
    const handleSelfChange = async (selectedOption) => {
        ...
        const getCellApiUrl = `http://localhost:5001/api/v1/seller/warehouse/cell/${selectedWarehouse}/${selectedArea}/${selectedRack}/${selectedSelf}/${shopInfo._id}`;
