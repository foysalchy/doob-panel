...
const SellerEditVariants = ({ adminWare, multiVendor, setMultiVendor, inputFields, setInputFields, daraz, variantInput, setVariantInput }) => {
            ...
            <div className='flex gap-4 flex-col w-full'>
                {inputFields && inputFields.map((field, index) => (
                    <div key={index} className=' border border-green-300 rounded px-4 py-2  w-full'>   <div className='flex gap-10 justify-between items-center'  >
                        ...
                        <div>
                            <label htmlFor={`coverPhoto-${index}`} className='bg-gray-300 w-20 h-20 flex justify-center items-center border border-black'> <br />
                                {field.image ? (
                        ...
                        <SellerEditStock field={field} index={index} inputFields={inputFields} setInputFields={setInputFields} />
                    </div>
                ...
                {multiVendor === true && <SellerEditVariantData variantInput={variantInput} setVariantInput={setVariantInput} />}
            </div>
