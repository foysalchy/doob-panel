...
const SellerEditStock = ({ field, index, inputFields, setInputFields }) => {
    return (
        <div>
            <div className='border mt-4 border-gray-400 md:px-10 px-2 py-5 w-full bg-gray-100 rounded'>
                ...
                <div className='grid items-center gap-4 md:grid-cols-5 mt-4'>
                    <div>
                        <label className='text-sm ' htmlFor="Video url ">Quantity</label> <br />
                        <input
                            onChange={(e) => {
                    ...
                    <div>
                        <label className='text-sm ' htmlFor="Video url ">SKU</label> <br />
                        <input
                            onChange={(e) => {
                                const newInputFields = [...inputFields];
                    ...
                    <div>
                        <label className='text-sm' htmlFor="Video url ">Normal Price BDT</label> <br />
                        <input
                            onChange={(e) => {
                                const newInputFields = [...inputFields];
                    ...
                    <div>
                        <label className='text-sm ' htmlFor="Video url ">Offer Price BDT</label> <br />
                        <input
                            onChange={(e) => {
                                const newInputFields = [...inputFields];
                    ...
                    <div className='min-w-fit'>
                        <label className='text-sm ' htmlFor="Video url ">Product Ability</label> <br />
                        <select
                            onChange={(e) => {
                                const newInputFields = [...inputFields];
...
export default SellerEditStock;