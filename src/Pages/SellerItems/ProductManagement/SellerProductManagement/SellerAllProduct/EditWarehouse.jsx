...
const EditWareHouse = ({ adminWare, setAdminWare, shopInfo }) => {
  ...
  const handleWarehouseChange = async (selectedOption) => {
    ...
    const getAreaApiUrl = `https://doob.dev/api/v1/seller/warehouse/area/${selectedWarehouse}/${shopInfo._id}`;
  ...
  const handleAreaChange = async (selectedOption) => {
    ...
    const getRackApiUrl = `https://doob.dev/api/v1/seller/warehouse/rack/${selectedWarehouse}/${selectedArea}/${shopInfo._id}`;
  ...
  const handleReckChange = async (selectedOption) => {
    ...
    const getSelfApiUrl = `https://doob.dev/api/v1/seller/warehouse/self/${selectedWarehouse}/${selectedArea}/${selectedRack}/${shopInfo._id}`;
  ...
  const handleSelfChange = async (selectedOption) => {
    ...
    const getCellApiUrl = `https://doob.dev/api/v1/seller/warehouse/cell/${selectedWarehouse}/${selectedArea}/${selectedRack}/${selectedSelf}/${shopInfo._id}`;
