    ...
    return (
        <div>
            <div className='border mt-4 border-gray-400 md:px-10 px-3 py-5 w-full bg-gray-100 rounded'>
                ...
                <div>
                    <label className='text-sm ' >Package Width (kg) </label> <br />
                ...
                <div className='md:mt-4 grid md:grid-cols-3 md:gap-4'>
                    <div>
                        <label className='text-sm ' >Length (cm)</label> <br />
                    ...
                    <div>
                        <label className='text-sm ' >Width (cm)</label> <br />
                    ...
                    <div>
                        <label className='text-sm ' >Height (cm)</label> <br />
                    ...
                    <div>
                        <label className='text-sm ' >Delivery Charge</label> <br />
