            ...
            <div>
                  ...
                  <div className="mt-4 gap-3 flex justify-center items-center">
                        ...
                        <button onClick={nextStep}
                              disabled={error}
                              className="group relative inline-flex items-center bar overflow-hidden rounded bg-gray-900 px-8 py-3 text-white focus:outline-none mt-4 disabled:cursor-not-allowed disabled:bg-gray-700"
