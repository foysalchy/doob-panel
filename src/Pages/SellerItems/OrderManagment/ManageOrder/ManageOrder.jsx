                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <form className='flex items-center bg-white '>
                            <input type="text" placeholder='Search' className="w-full border-gray-400 p-2 border" />
                            <button type="submit" className='bg-gray-200 border border-gray-200 px-6 py-2 h-full' >Search</button>
                        </form>
                    </div>
                </div>
