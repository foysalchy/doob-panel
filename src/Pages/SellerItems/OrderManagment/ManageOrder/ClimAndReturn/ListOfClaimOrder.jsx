                    ...
                    <div className="inline-block  min-w-full py-2 sm:px-6 lg:px-8">
                        <div className="overflow-hidden">
                            ...
                            <table className="w-full bg-white border text-center text-sm font-light">
                                ...
                                <tbody>
                                    {currentItems?.filter(item => item.status === 'claim')?.map((item, index) => (
                                        <React.Fragment key={item._id}>
                                            <tr className={index % 2 === 0 ? "bg-gray-100" : ""}>
                                                <td scope="col" className="border-r px-2 py-4 font-[500]">
                                                    <input type='checkbox' name="" id="" checked={selectAll} />
                                                </td>
                                                ...
                                                <td className="border-r px-6 py-4">
                                                    <Link to='/seller/orders/manage-order/order-checkup' onClick={() => setCheckUpData(item)} className="text-blue-500 font-[400]">{item?.orderNumber}</Link>
                                                </td>
