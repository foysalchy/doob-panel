...
const SellerManageCell = () => {
      ...
      const { data: cells = [], refetch, isLoading: loadingData } = useQuery({
            ...
            queryFn: async () => {
                  const res = await fetch(
                        `https://doob.dev/api/v1/seller/warehouse/cell/${shopInfo._id}`
                  );
      ...
      const updateStatus = (id, status) => {
            fetch(
                  `https://doob.dev/api/v1/seller/warehouse/cell/status/${id}`,
                  {
                        method: "PUT",
                        headers: {
      ...
      const DeleteWarehouse = (id) => {
            ...
            Swal.fire({
                  ...
                  if (result.dismiss === Swal.DismissReason.timer) {
                        ...
                        fetch(
                              `https://doob.dev/api/v1/seller/warehouse/cell/delete/${id}`,
                              {
                                    method: "DELETE",
                                    headers: {
                                          "Content-Type": "application/json",
            ...
            <div>
                  <div className="mt-4 lg:pr-10 w-full mx-auto bar overflow-hidden">
                        ...
                        <div className="flex items-center overflow-auto justify-between">
                              ...
                              <button
                                    className="group relative inline-flex items-center bar overflow-hidden rounded bg-gray-900 px-8 py-3 text-white focus:outline-none focus:ring active:bg-gray-500 md:w-auto w-[130px]"
