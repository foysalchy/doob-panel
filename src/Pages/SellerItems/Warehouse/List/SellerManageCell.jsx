...
const SellerManageCell = () => {
    ...
    const { data: cells = [], refetch } = useQuery({
        queryKey: ["cells"],
        queryFn: async () => {
            const res = await fetch(`http://localhost:5001/api/v1/seller/warehouse/cell/${shopInfo._id}`);
    ...
    const updateStatus = (id, status) => {
        fetch(`http://localhost:5001/api/v1/seller/warehouse/cell/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DeleteWarehouse = (id) => {
        ...
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                ...
                fetch(`http://localhost:5001/api/v1/seller/warehouse/cell/delete/${id}`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    },
