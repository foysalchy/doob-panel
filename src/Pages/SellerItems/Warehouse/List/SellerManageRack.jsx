...
const SellerManageRack = () => {
    ...
    const { data: racks = [], refetch } = useQuery({
        queryKey: ["racks"],
        queryFn: async () => {
            const res = await fetch(`https://backend.doob.com.bd/api/v1/seller/warehouse/rack/${shopInfo._id}`);
            const data = await res.json();
            return data;
        },
    });

    console.log(`https://backend.doob.com.bd/api/v1/seller/warehouse/rack/${shopInfo._id}`);
    ...
    const updateStatus = (id, status) => {
        fetch(`https://backend.doob.com.bd/api/v1/seller/warehouse/rack/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DeleteWarehouse = (id) => {
        ...
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                ...
                fetch(`https://backend.doob.com.bd/api/v1/seller/warehouse/rack/delete/${id}`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    },
