...
const SellerAreaListForWarehouse = () => {
    ...
    const { data: areas = [], refetch } = useQuery({
        queryKey: ["areas"],
        queryFn: async () => {
            const res = await fetch(`https://salenow-v2-backend.vercel.app/api/v1/seller/warehouse/area/get/${shopInfo._id}`);
    ...
    const updateStatus = (id, status) => {
        fetch(`https://salenow-v2-backend.vercel.app/api/v1/seller/warehouse/area/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DeleteWarehouse = (id) => {
        ...
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                ...
                fetch(`https://salenow-v2-backend.vercel.app/api/v1/seller/warehouse/area/delete/${id}`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    },
    ...
    return (
        <div>
            <div className="mt-4 lg:pr-10 w-full mx-auto overflow-hidden">
                ...
                {OpenModal === 'Add Area' && <SellerModalForWarehouse OpenModal={OpenModal} setOpenModal={setOpenModal} data={'Add Area'} refetch={refetch} />}
