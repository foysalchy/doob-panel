...
const SellerAreaListForWarehouse = () => {
    ...
    const { data: areas = [], refetch } = useQuery({
        queryKey: ["areas"],
        queryFn: async () => {
            const res = await fetch(`http://localhost:5001/api/v1/seller/warehouse/area/get/${shopInfo._id}`);
    ...
    const updateStatus = (id, status) => {
        fetch(`http://localhost:5001/api/v1/seller/warehouse/area/status/${id}`, {
            method: "PUT",
            headers: {
    ...
    const DeleteWarehouse = (id) => {
        ...
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                ...
                fetch(`http://localhost:5001/api/v1/seller/warehouse/area/delete/${id}`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    },
