...
const SellerAddCellModal = ({ recall, setOpenModal }) => {
    ...
    const { data: warehouses = [], refetch } = useQuery({
        queryKey: ["warehouses"],
        queryFn: async () => {
            const res = await fetch(`http://localhost:5001/api/v1/seller/warehouse/get/${shopInfo._id}`);
    ...
    const handleWarehouseChange = async (selectedOption) => {
        ...
        const areaRes = await fetch(`http://localhost:5001/api/v1/seller/warehouse/area/${selectedWarehouse}/${shopInfo._id}`);
    ...
    const handleAreaChange = async (selectedOption) => {
        ...
        const rackRes = await fetch(`http://localhost:5001/api/v1/seller/warehouse/rack/${selectedWarehouse}/${selectedArea}/${shopInfo._id}`);
    ...
    const handleReckChange = async (selectedOption) => {
        ...
        const selfRes = await fetch(`http://localhost:5001/api/v1/seller/warehouse/self/${selectedWarehouse}/${selectedArea}/${selectedRack}/${shopInfo._id}`);
        console.log(selfRes);
    ...
    const UploadArea = (e) => {
        ...
        fetch('http://localhost:5001/api/v1/seller/warehouse/cell', {
            method: 'post',
            headers: {
