      ...
      return (
            <div>
                  <form onSubmit={UploadArea} action="">
                        ...
                        <button
                              type="submit"
                              className="group mt-10 relative inline-flex items-center bar overflow-hidden rounded bg-gray-900 px-8 py-3 text-white focus:outline-none focus:ring active:bg-gray-500"
                        >
