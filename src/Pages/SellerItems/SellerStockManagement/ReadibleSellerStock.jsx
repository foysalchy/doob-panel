      ...
      return (
            <div className="relative">
                  <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                        ...
                        <div ref={componentRef} className="relative print-main-box w-full rounded-lg bar overflow-hidden h-screen">

                              <div className="bar overflow-x-auto absolute print-table top-0 left-0 right-0 border w-full dark:border-gray-200 border-gray-700 md:rounded-lg">
