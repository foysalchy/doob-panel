            ...
            <div>
                  ...
                  <div className="md:flex justify-between ">
                        <div className="flex items-center gap-x-3  mb-3 md:mb-0">
                              <h2 className="text-lg font-medium text-gray-700 "> Blogs</h2>
                        ...
                        <Link
                              className="group relative inline-flex items-center bar overflow-hidden rounded bg-gray-900 md:px-8 px-3 py-3 text-white focus:outline-none focus:ring active:bg-gray-500"
                              ...
                              <button
                                    ...
                                    className={
                                          blogType
                                                ...
                                                : "bg-gray-900 rounded cursor-pointer text-white px-4 py-2"
                                    }
                              >
                                                                  ...
                                                                  <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                                        <div className="flex gap-4 justify-center">
                                                                              ...
                                                                              {trashType && (
                                                                                    <TbRestore
                                                                                          onClick={() => blogStash(blog._id, false)}
                                                                                          className="transition-colors text-xl duration-200 cursor-pointer text-green-500 hover:text-green-700 focus:outline-none"
                                                                                    />
                                                                              )}
                                                                              <BiEdit
