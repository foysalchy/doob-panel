...
const BlogCategorySeller = () => {
  ...
  const DeleteCategory = (id) => {
    fetch(
      `https://salenow-v2-backend.vercel.app/api/v1/seller/DeleteBlogCategoryById?id=${id}`,
      {
        method: "DELETE",
        headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(
      `https://salenow-v2-backend.vercel.app/api/v1/seller/update-blog-category`,
      {
        method: "PUT",
        headers: {
          "content-type": "application/json",
                ...
                <tr key={index}>
                  ...
                  <td className="whitespace-nowrap px-4 py-2">
                    <div className="flex items-center gap-2">
                      ...
                      <Link to={`/shop/${shopInfo.shopId}/blog#${cate.slag}`}>
...
export default BlogCategorySeller;
