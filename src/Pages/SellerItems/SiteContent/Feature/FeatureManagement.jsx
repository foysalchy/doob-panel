...
const FeatureManagement = () => {
    ...
    const handleEditItem = async (e, id) => {
        ...
        fetch(`https://salenow-v2-backend.vercel.app/api/v1/seller/feature/update?id=${id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    return (
        <div>
            <div className='h-0 w-0'>   <DeleteModal setOpenModal={setDeleteOn} OpenModal={deletePopUp} setIsDelete={setIsDelete} /></div>
            <div className=''>
                {selectedImage && (
                            ...
                            <div className="overflow-hidden border  border-gray-700 md:rounded-lg">
                                <table className="min-w-full divide-y  divide-gray-700">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200 ">
                                        {faqs?.sort((a, b) => parseInt(a.index) - parseInt(b.index))?.map((faq, index) => (
                                            <tr>
                                                ...
                                                <div className={`fixed z-[100] flex items-center justify-center ${openModal?._id === faq?._id ? 'opacity-1 visible' : 'invisible opacity-0'} inset-0 bg-black/20 backdrop-blur-sm duration-100`}>
                                                    <div className={`absolute md:w-[500px] w-full rounded-sm bg-white p-3 pb-5 text-center drop-shadow-2xl ${openModal?._id === faq?._id ? 'scale-1 opacity-1 duration-300' : 'scale-0 opacity-0 duration-150'} `}>
                                                        ...
                                                        <form onSubmit={(e) => handleEditItem(e, faq?._id)}>

                                                            <h1 className="text-lg font-semibold text-center mb-4">
                                                                Edit Feature Image
                                                            </h1>

                                                            <img src={faq?.image} alt="" className="w-[100px] h-[100px] rounded" />
                                                            ...
                                                            <div className="flex flex-col items-start gap-1">
                                                                <label className='text-start' htmlFor="url">URL</label>
                                                                <input
                                                                    defaultValue={openModal?.link}
                                                                    type="url" name="url" className='border border-gray-500 p-1 rounded mb-3 w-full' />
                                                            </div>
                                                            <div className="flex flex-col items-start gap-1">
                                                                <label className='text-start' htmlFor="index">Index</label>
                                                                <select
