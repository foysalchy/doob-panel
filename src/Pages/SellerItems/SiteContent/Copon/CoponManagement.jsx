                                                                  ...
                                                                  <tr>
                                                                              ...
                                                                              <div className="inline-flex items-center gap-3">
                                                                                    <div className="inline-flex items-center gap-x-3">
                                                                                          <div className="font-medium text-gray-800  whitespace-pre-wrap ">
                                                                                                ...
                                                                                                >
                                                                                                      {copiedIndex === index ? (
                                                                                                            <FaRegCopy className="text-green-700" />
                                                                                                      ) : (
                                                                                                            <FaRegCopy className="text-gray-900" />
                                                                                                      )}
                                                                                                </button>
                                                                                          </div>
                                                                                    </div>
                                                                        ...
                                                                        <td className="px-4 py-4 text-sm font-medium text-gray-700">
                                                                              <div className="font-medium text-center text-gray-800   ">
                                                                                    {faq?.startDateTime && (
                                                                                          <p>
                                                                                                {new Date(faq?.startDateTime).toLocaleString()}{" "}
                                                                                                to {new Date(faq?.endDateTime).toLocaleString()}
                                                                                          </p>
                                                                                    )}
                                                                              </div>
                                                                        </td>
