...
const ShopInformation = () => {
    ...
    return (
        <div className="flex-1 bg-white -lg shadow-xl p-8">
            ...
            <ul className="mt-2 text-gray-700">
                ...
                {shopInfo?.domain && <li li className="flex border-y py-2">
                ...
                <li className="flex border-b py-2">
                    ...
                    <span className="text-gray-700">{convertTimestampToFormattedDate(shopInfo.date)}</span>
                </li>
                <li className="flex border-b py-2">
