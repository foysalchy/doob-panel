                  ...
                  <div className=" h-screen">
                        <div className="flex border border-grey rounded shadow-lg h-full">
                              ...
                              <div className="w-1/3 border flex flex-col">
                                    ...
                                    {/* Contacts */}
                                    <div className="bg-grey-lighter flex-1 bar overflow-auto">
                                          ...
                                          </div>   <div className="bg-white px-3 flex items-center hover:bg-grey-lighter cursor-pointer">
                                                <div>
                                                      <img
                                                            className="h-12 w-12 rounded-full"
                                                            src="https://www.famousbirthdays.com/headshots/russell-crowe-6.jpg"
                              ...
                              <div className="w-2/3 border flex flex-col">
                                    ...
                                    {/* Messages */}
                                    <div
                                          className="flex-1 bar overflow-auto"
