...
const FinanceReport = () => {
    ...
    const fetchFinancialReport = async () => {
        const apiUrl = 'https://salenow-v2-backend.vercel.app/api/v1/seller/my-financial-report';
        try {
                ...
                <div className="border mt-4 mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                    <div className="p-4">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <div className="text-gray-900">{new Date(startDate).toDateString()} to {new Date(endDate).toDateString()}</div>
                        </div>
                    ...
                    {Object.entries(financialReport).map(([key, value]) => (
                        <div className="flex justify-between items-center bg-gray-100 p-4">
                            ...
                            <div className="text-lg font-semibold text-gray-700"> <span className=' kalpurush'>৳</span> {value}</div>
                        </div>
