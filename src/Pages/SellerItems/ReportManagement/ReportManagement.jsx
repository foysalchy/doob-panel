        ...
        <div>
            <div className='grid grid-cols-3 gap-4 py-10 pr-10'>
                <Link
                    ...
                    className="group relative inline-flex items-center justify-center overflow-hidden rounded bg-gray-800 px-8 py-6 text-white focus:outline-none focus:ring active:bg-gray-500"
