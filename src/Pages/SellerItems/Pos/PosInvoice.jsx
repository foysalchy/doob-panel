...
const PosInvoice = ({ setOpen, setUser, invoiceData, setInvoiceOpen, invoiceOpen, setCash, setGest, setDiscount }) => {
                                        ...
                                        invoiceData?.invoice?.items?.map((itm, index) => (
                                            <li key={index} className="py-2 border-b border-gray-700">
                                                <div className="flex justify-between items-start">
                                                    <span>{`(${index + 1})`}</span>
                                                    <h2 className="w-[190px] text-start text-sm">{itm?.name}</h2>
                                                    <div className="">
