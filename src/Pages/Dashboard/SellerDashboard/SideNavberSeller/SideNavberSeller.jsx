...
import { MdContacts, MdOutlineAddCircleOutline, MdOutlineManageSearch } from 'react-icons/md';
...
const SideNavberSeller = () => {
    ...
    return (
        <div>
            ...
            <div className={responsive ? "flex flex-col h-screen  p-3 w-30  border-r-2 bg-gray-900 text-gray-100" : "flex flex-col  p-6 w-60  h-screen bg-gray-900 text-gray-100 border-r-2"}>
                <div className="space-y-3">
                    ...
                    {!responsive && <div className="flex-1 ">
                                    ...
                                    <ul className="mt-2 space-y-1 px-4">
                                        <li className='flex cursor-pointer items-center justify-between  rounded-sm hover:bg-gray-800 text-gray-50'>
                                            <Link
                                                ...
                                                className="  text-gray-50 flex gap-2 items-center px-4 p-2 space-x-3 rounded-md"
                                            >
                                                <MdOutlineAddCircleOutline className='w-5 h-5 fill-current text-gray-400' />   Add Page
                                            </Link>
                                        </li>
                                        ...
                                        <li className='flex cursor-pointer items-center justify-between  rounded-sm hover:bg-gray-800 text-gray-50'>
                                            <Link
                                                ...
                                                className=" text-gray-50 flex gap-2 items-center px-4 p-2 space-x-3 rounded-md"
                                            >
                                                <MdOutlineManageSearch className='w-5 h-5 fill-current text-gray-400' />  Manage Pages
                                            </Link>
                                        </li>
                                    </ul>
                                </details>
                ...
                {!responsive && <div className="flex items-center   p-2 mt-12 space-x-4 justify-self-end">
                    <img src={shopInfo.logo} alt="" className="w-12 h-12 rounded-lg bg-gray-500" />
