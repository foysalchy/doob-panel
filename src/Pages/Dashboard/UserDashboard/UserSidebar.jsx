...
const UserSidebar = () => {
      ...
      return (
            <div className='h-screen'>
                  ...
                  <div id="Main" className="xl:rounded-r transform  h-full xl:translate-x-0  ease-in-out transition duration-500 flex flex-col justify-between  items-start w-full sm:w-64 bg-gray-900">
                        <div className="w-full">
                              ...
                              <div className="mt-6 h-full flex flex-col justify-start items-center  pl-4 w-full space-y-3 pb-5 ">
                                    ...
                                    <NavLink rel=" noopener noreferrer" to='wishlist' className={({ isActive }) => {
                                          ...
                                          <BiHomeAlt className="w-5 h-5 fill-current text-gray-400" />
                                          <p className="text-base leading-4 ">My WishList</p>
                                    </NavLink>
                        ...
                        <div className="flex flex-col border-t border-gray-700 pt-2 justify-between items-center  pb-6   px-6  w-full  space-y-32 ">
