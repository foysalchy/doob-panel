                    ...
                    {menu && (
                      <li onMouseMove={() => setMenu(true)} className="relative w-full">
                        ...
                        <div className="group [&_summary::-webkit-details-marker]:hidden block w-full  rounded-sm  ">
                          ...
                          {openDropdownIndex == 102 && <ul className="mt-2 space-y-1 px-2 border border-white border-opacity-40 py-2">
                            {!user?.staffRole ||
                              user?.permissions.find(
                                (itm) => itm?.name === "Orders"
                              ) ? (
                  ...
                  <>
                    {menu && (
                      ...
                      >
                        ...
                        >
                          <div onClick={() => handleToggle(3)} className="flex w-full cursor-pointer  justify-between  p-2 rounded-sm hover:bg-gray-800 text-white hover:text-gray-50">
                            <div className="flex cursor-pointer  gap-2">
                  ...
                  <>
                    {menu && (
                      <li onMouseMove={() => setMenu(true)} className="">
                        ...
                        >
                          <div onClick={() => handleToggle(8)} className="flex cursor-pointer w-full  justify-between text-white  p-2 rounded-sm hover:bg-gray-800  hover:text-gray-50">
                            <div className="flex cursor-pointer  gap-2">
                    ...
                    {menu && (
                      <li onMouseMove={() => setMenu(true)} className="">
                        <div
                          ...
                          className="group [&_summary::-webkit-details-marker]:hidden w-full flex flex-col  rounded-sm  "
                        >
                          <div onClick={() => handleToggle(13)} className="flex cursor-pointer w-full  justify-between text-white  p-2 rounded-sm hover:bg-gray-800  hover:text-gray-50">
                            <div className="flex cursor-pointer  gap-2">
                             ...
                             <li className="flex cursor-pointer  justify-between  rounded-sm hover:bg-gray-800 hover:text-gray-50 text-white">
                              ...
                              <li className="flex cursor-pointer  justify-between  rounded-sm hover:bg-gray-800 hover:text-gray-50 text-white">
                                <Link
                                  ...
                                  className="w-full"
                                >
                                  <div className="hover:text-gray-50 flex gap-2  px-2 p-2 space-x-3  rounded-md">Package Handle</div>
                                </Link>
                              </li>
                ...
                user?.permissions.find(
                  ...
                  <>
                    {menu && (
                      <li onMouseMove={() => setMenu(true)} className="">
                        <div
                          className="group [&_summary::-webkit-details-marker]:hidden flex flex-col  w-full rounded-sm  "
                        >
                          <div onClick={() => handleToggle(9)} className="flex cursor-pointer  justify-between w-full text-white  p-2 rounded-sm hover:bg-gray-800  hover:text-gray-50">
                            <div className="flex cursor-pointer  gap-2">
