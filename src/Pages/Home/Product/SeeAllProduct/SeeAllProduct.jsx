                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="inline-flex rounded-lg shadow-sm">
                    <button
                      ...
                      type="button"
                      className={`py-2 px-2 inline-flex items-center gap-x-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 ${
                        isGrid === "grid" ? "bg-gray-900 text-red-500" : ""
                    ...
                    <button
                      ...
                      type="button"
                      className={`py-2 px-2 inline-flex items-center gap-x-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 ${
                        isGrid === "list" ? "bg-gray-900 text-red-500" : ""
                      }  text-gray-800 shadow-sm  disabled:opacity-50 disabled:pointer-events-none   `}
                    >
