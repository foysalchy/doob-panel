        ...
        <div className='bg-gray-200'>
            <div className='px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 py-10 gap-5">
                    <div className="group md:h-72 h-56 hover:h-auto relative block overflow-hidden rounded hover:text-white text-black hover:bg-black bg-indigo-50">
                        ...
                        <div className="relative p-4 sm:p-6 lg:p-8 group">
                            ...
                            <p className="text-xl font-bold sm:text-xl">
                    ...
                    <div className="group  md:h-72 h-56 hover:h-auto relative block overflow-hidden rounded hover:text-white text-black hover:bg-black bg-indigo-50">
                        ...
                        <div className="relative p-4 sm:p-6 lg:p-8 group">
                            ...
                            <p className="text-xl font-bold sm:text-xl">Batch Order Processing
                    ...
                    <div className="group  md:h-72 h-56 hover:h-auto relative block overflow-hidden rounded hover:text-white text-black hover:bg-black bg-indigo-50">
                        ...
                        <div className="relative p-4 sm:p-6 lg:p-8 group">
                            ...
                            <p className="text-xl font-bold sm:text-xl">Customized Shipping Label
                    ...
                    <div className="group  md:h-72 h-56 hover:h-auto relative block overflow-hidden rounded hover:text-white text-black hover:bg-black bg-indigo-50">
                        ...
                        <div className="relative p-4 sm:p-6 lg:p-8 group">
                            ...
                            <p className="text-xl font-bold sm:text-xl">Sync Inventory
                            </p>
                    ...
                    <div className="group  md:h-72 h-56 hover:h-auto relative block overflow-hidden rounded hover:text-white text-black hover:bg-black bg-indigo-50">
                        ...
                        <div className="relative p-4 sm:p-6 lg:p-8 group">
                            ...
                            <p className="text-xl font-bold sm:text-xl">Automated Operations
                            </p>
                    ...
                    <div className="group  md:h-72 h-56 hover:h-auto relative block overflow-hidden rounded hover:text-white text-black hover:bg-black bg-indigo-50">
                        ...
                        <div className="relative p-4 sm:p-6 lg:p-8 group">
                            ...
                            <p className="text-xl font-bold sm:text-xl">Watermark Template
                            </p>
                    ...
                    <div className="group   h-72 hover:h-auto relative block overflow-hidden rounded hover:text-white text-black hover:bg-black  bg-indigo-50">
                        ...
                        <div className="relative p-4 sm:p-6 lg:p-8 group">
                            ...
                            <p className="text-xl font-bold sm:text-xl">Smart Scan Mobile App</p>
