                  ...
                  <div className=" ">
                        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                              <div className="relative bg-black rounded-2xl lg:px-40 px-10 py-5 lg:py-10 text-center">
                                    ...
                                    <form
                                          onChange={() => setError("")}
                                          onSubmit={fromNewsLetter}
                                          className="flex flex-col items-start gap-4 w-full mb-4 md:flex-row md:px-16"
                                    >
                                          ...
                                          <button className="inline-flex items-center justify-center w-full h-12 px-6 font-semibold tracking-wide  transition duration-200 rounded shadow-md md:w-auto text-black bg-white hover:bg-gray-300 focus:shadow-outline focus:outline-none">
                                                Subscribe
                                          </button>
                                    </form>
                              </div>
