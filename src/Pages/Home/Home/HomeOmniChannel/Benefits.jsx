            ...
            <div style={{ background: "#f2f0fa" }}>
                ...
                <div className="grid gap-8 grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-700 text-sm">
                            Doob is the third-party e-commerce ERP certified by mainstream marketplaces in Southeast Asia.
                        </p>
                    </div>
                    <div className="text-center">
                        <div className="flex items-center justify-center w-16 h-16 gap-3 mx-auto mb-3 rounded-xl bg-white ">
                              ...
                              <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                                    <div className="md:p-8 lg:p-14">
                                          ...
                                          <p className="mt-5 text-base text-gray-600 font-pj">
                                                Receive dedicated customer service 6 days a week for 12 hours a day. Our prompt and personalized support ensures you overcome challenges and boost productivity.  </p>
                                    </div>
                                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                                          ...
                                          <p className="mt-5 text-base text-gray-600 font-pj">
                                                Our expert sales team helps you maximize revenue through tailored strategies and market insights, guiding you to achieve your sales goals.
                                          </p>
                                    </div>
                                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                                          <svg
                                          ...
                                          <p className="mt-5 text-base text-gray-600 font-pj">
                                                Experience a seamless onboarding process with comprehensive training and resources to get you up and running quickly, ensuring effective product use.
                                          </p>
                                    </div>
                                    <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                                          ...
                                          <p className="mt-5 text-base text-gray-600 font-pj">
                                                Our solutions are designed to meet your business needs with the latest features and functionalities. We ensure a user-friendly experience that enhances your operational efficiency.
                                          </p>
                                    </div>
                                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                                          ...
                                          <p className="mt-5 text-base text-gray-600 font-pj">
                                                We prioritize quality in every aspect of our products. Each solution is rigorously tested to meet industry standards, ensuring reliability and performance that you can trust for your business success.
                                          </p>
                                    </div>
                                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                                          <svg
                                          ...
                                          <p className="mt-5 text-base text-gray-600 font-pj">
                                                Expect measurable improvements in efficiency, productivity, and customer satisfaction. We provide regular updates to track your progress and demonstrate the impact of our collaboration.
                                          </p>
                                    </div>
                              </div>
                        </div>
