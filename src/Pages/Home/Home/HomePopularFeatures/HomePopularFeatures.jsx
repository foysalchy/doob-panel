            ...
            <div className='bg-indigo-50'>
                  <div className='px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
                        ...
                        <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 py-10 gap-5">
                              <div className="group md:h-72 h-56  scroll-smooth relative   bar overflow-hidden rounded hover:text-black text-black  bg-white">
                              ...
                              <div
                                    className="group md:h-72 h-56  scroll-smooth relative  bar overflow-hidden rounded hover:text-black text-black bg-white"
                              ...
                              <div
                                    className="group md:h-72 h-56  hover:bar overflow-y-scroll scroll-smooth relative  bar overflow-hidden rounded hover:text-black text-black bg-white"
                              ...
                              <div className="group   h-72  scroll-smooth relative  bar overflow-hidden rounded hover:text-black text-black   bg-white">
