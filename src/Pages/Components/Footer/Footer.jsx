    ...
    return (
        <div>
            <footer className="px-4 divide-y bg-gray-800 text-gray-100">
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 flex flex-col justify-between  space-y-8 lg:flex-row lg:space-y-0">
