                ...
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-6 lg:max-w-sm text-sm text-white">
                            ...
                            BigSeller is a SaaS platform that automates & simplifies multichannel e-commerce selling processes. <br /> With BigSeller, it is more efficient to create listings and process orders from a single system
                        </div>
                    </div>
