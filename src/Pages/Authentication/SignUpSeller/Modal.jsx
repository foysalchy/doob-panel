...
const Modal = ({ email, modalOpen, setModalOpen }) => {
    ...
    const handleSubmit = () => {
        ...
        fetch('http://localhost:5000/api/v1/admin/refer-code', {
            method: 'POST',
                        ...
                        <div className="flex flex-wrap -mx-3">
                            <div onClick={() => setModalOpen(false)} className="w-1/2 px-3">
                                <button
                                    ...
                                    className="block w-full rounded-lg border border-red-500 p-3 text-center text-base font-medium text-dark transition hover:border-red-600 hover:bg-red-600 hover:text-white"
                                >
                                    I don't have refer code
                                </button>
                            </div>
                            <button disabled={loading} onClick={() => handleSubmit()} className="w-1/2 px-3">
                                <div
