    ...
    children: [
      ...
      },
      {
        ...
        loader: async ({ params }) => {
          ...
          const response = await fetch(`http://localhost:5001/api/v1/seller/admin-category-item?id=${categoryName}`);
      ...
      },
      {
        path: ":id",
        loader: ({ params }) =>
          fetch(`http://localhost:5001/api/v1/admin/single-product?id=${params?.id}`),
        element: <>
          {/* <ScrollToTop /> */}
          <ProductDetails />
        </>,
