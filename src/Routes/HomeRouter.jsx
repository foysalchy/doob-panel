...
const homePath = [
    ...
    },
    {
        ...
        loader: ({ params }) =>
            fetch(`http://localhost:5001/api/v1/admin/service/${params.id}`)
    },
    {
    ...
    },
    {
        ...
        element: <SingleBlog />,
        loader: ({ params }) =>
            fetch(`http://localhost:5001/api/v1/admin/all-blogs/${params.id}`),
    },
    {
        path: "/faq",
        ...
        children: [
            ...
            },
            {
                ...
                element: <SingleFaq />,
                loader: ({ params }) =>
                    fetch(`http://localhost:5001/api/v1/admin/faq/${params.id}`),
            },
        ],
    },
    {
        ...
        element: <Trams />,
        loader: ({ params }) =>
            fetch(`http://localhost:5001/api/v1/admin/page/${params.id}`),
    },
    {
        path: "/profile",
        element: <Profile />,
