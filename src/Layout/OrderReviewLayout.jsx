      ...
      return (
            <div className="h-screen grid grid-cols-5">
                  <div className="sidebar h-full p-4">
                        <div className="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] bar overflow-y-auto text-center bg-gray-900">
                  ...
                  <div className="content bar overflow-x-hidden bar overflow-y-scroll bg-gray-100 h-full col-span-4 p-6">
                        <Outlet />
                  </div>
            </div>
      );
